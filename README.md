...
## Model Evaluation:
When we're done with model building and residual analysis and have made predictions on the test set, we need to make sure we use the following two lines of code to calculate the R-squared score on the test set.
